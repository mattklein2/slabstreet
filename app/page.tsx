  ...
  return (
    <div style={{ background: '#090b0f', minHeight: '100vh', color: '#e8edf5', fontFamily: 'IBM Plex Sans, sans-serif', overflowX: 'hidden' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
          ...
          <input
            ...
            style={{
              ...
              /*
               * iOS ZOOM FIX:
               * Safari zooms in whenever an input has font-size < 16px.
               * Setting to 16px prevents the zoom entirely.
               * The page never snaps back on its own — this is the only real fix.
               */
              fontSize: 16,
              outline: 'none',
          ...
          {searched && (
            <div style={{
              ...
              {results.length === 0 ? (
                ...
                <a key={p.slug} href={`/players/${p.slug}`} style={{
                  display: 'flex',
                  alignItems: 'center',
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '64px 24px 48px' }}>
        <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: '#00ff87', letterSpacing: 3, marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <a href="#features" style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 12, letterSpacing: 2, padding: '12px 24px', background: '#00ff87', color: '#090b0f', borderRadius: 3, textDecoration: 'none', fontWeight: 700 }}>
            See Features
          </a>
          <a href="/players/wemby" style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 12, letterSpacing: 2, padding: '12px 24px', background: 'transparent', color: '#00ff87', border: '1px solid #00ff87', borderRadius: 3, textDecoration: 'none' }}>
            Search Players →
          </a>
        </div>
      </div>
      ...
      <div id="features" style={{ maxWidth: 900, margin: '0 auto', padding: '64px 24px' }}>
        ...
        <div style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(32px, 6vw, 52px)', letterSpacing: 2, color: '#e8edf5', marginBottom: 40 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
          {features.map((f, i) => (
            <div key={i} style={{
              background: '#0f1318',
              border: '1px solid #1e2530',
              borderTop: `3px solid ${f.status === 'Live' ? '#00ff87' : '#1e2530'}`,
              borderRadius: 4,
              padding: '20px',
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                ...
                <span style={{
                  ...
                  padding: '2px 7px',
                  borderRadius: 2,
                  border: `1px solid ${f.status === 'Live' ? '#00ff87' : '#1e2530'}`,
                  color: f.status === 'Live' ? '#00ff87' : '#8899aa',
                }}>{f.status}</span>
              </div>

...
const PRODUCT_ID = 'c0000000-0000-0000-0000-00000000003f';
const ALL = 'All';
const parallels = [
  { name: 'Base', color_hex: '#FFFFFF', print_run: null, serial_numbered: false, is_one_of_one: false, rarity_rank: 1, box_exclusivity: [ALL], description: 'Standard base card; 57-card set' },
  { name: 'Blue', color_hex: '#4169E1', print_run: 99, serial_numbered: true, is_one_of_one: false, rarity_rank: 2, box_exclusivity: [ALL], description: 'Blue /99' },
  { name: 'Green', color_hex: '#228B22', print_run: 75, serial_numbered: true, is_one_of_one: false, rarity_rank: 3, box_exclusivity: [ALL], description: 'Green /75' },
  { name: 'Purple', color_hex: '#9370DB', print_run: 49, serial_numbered: true, is_one_of_one: false, rarity_rank: 4, box_exclusivity: [ALL], description: 'Purple /49' },
  ...
  { name: 'Gold Framed', color_hex: '#FFD700', print_run: 1, serial_numbered: true, is_one_of_one: true, rarity_rank: 8, box_exclusivity: [ALL], description: 'Gold framed — true 1/1' },
];
async function main() {
  console.log(`Seeding 2025 Lights Out F1: ${parallels.length} parallels`);

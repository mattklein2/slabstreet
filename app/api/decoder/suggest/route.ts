  ...
  try {
    ...
    const cleaned = suggestions
      ...
      .filter(s => {
        ...
        const skip = new Set(['topps', 'panini', 'chrome', 'prizm', 'donruss', 'optic', 'select', 'mosaic', 'hoops', 'bowman', 'heritage', 'finest', 'upper', 'deck', 'basketball', 'football', 'baseball', 'hockey', 'nba', 'nfl', 'mlb', 'nhl', 'auto', 'autograph', 'signed', 'rookie', 'card', 'cards', 'lot', 'psa', 'bgs', 'sgc', 'cgc', 'base', 'refractor', 'parallel', 'insert', 'patch', 'jersey', 'relic', 'memorabilia', 'swatch', 'blue', 'red', 'green', 'gold', 'silver', 'purple', 'orange', 'black', 'pink', 'white', 'yellow', 'bronze', 'platinum', 'sapphire', 'ruby', 'emerald', 'target', 'walmart', 'scan', 'slam', 'kings', 'aces', 'diamante', 'foil', 'holo', 'wave', 'mega', 'blaster', 'hobby', 'jumbo', 'case', 'box', 'pack', 'break', 'rip', 'cello', 'fat', 'hanger', 'anniversary', 'edition', 'series', 'set', 'complete', 'graded', 'raw', 'slab', 'team', 'draft', 'picks', 'midnight', 'variation', 'short', 'print', 'sp', 'ssp']);
